{{-- {{ dd(\Laratrust::hasRole('user')) }} --}}
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Blog IT | Dashboard</title>
  ...
  <meta content="ChienDZ" name="author" />
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="{{ route('admin.dashboard') }}" class="logo">
        ...
        <span class="logo-lg">BLOG<b> IT</b></span>
      </a>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="@if(Auth::user()->avatar) {{ asset(Auth::user()->avatar)  }} @else {{ asset('admin_assets/avatar.png') }} @endif" class="user-image" alt="User Image">
                <span class="hidden-xs">{{ Auth::user()->full_name }}</span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="@if(Auth::user()->avatar) {{ asset(Auth::user()->avatar )}} @else {{ asset('admin_assets/avatar.png') }} @endif" class="img-circle" alt="User Image">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="{{asset('admin/profile')}}/{{Auth::user()->id}}" class="btn btn-default btn-flat">Profile</a>
                  </div>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2018 
        <a href="https://www.facebook.com/oh.nguyen.3" title="Facebook" target="_blank">Chiến Nguyễn</a>
    </footer>
    <!-- END FOOTER -->
